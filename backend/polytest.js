                            ...
                            (t.prototype.runTask = function (e, t, n) {
                                ...
                                if (e.state !== b || (e.type !== Z && e.type !== P)) {
                                    ...
                                    try {
                                        ...
                                        e.state !== b && e.state !== O && (e.type == Z || (e.data && e.data.isPeriodic) ? r && e._transitionTo(T, E) : ((e.runCount = 0), this._updateTaskCount(e, -1), r && e._transitionTo(b, E, b))),
                                            (C = C.parent),
                                            (z = o);
                                    }
                                }
                        ...
                        u = (function () {
                            function e(e, t, n) {
                                ...
                                (r || (t && t._hasTaskZS)) &&
                                    ...
                                    n.onScheduleTask || ((this._scheduleTaskZS = l), (this._scheduleTaskDlgt = t), (this._scheduleTaskCurrZone = this.zone)),
                                    n.onInvokeTask || ((this._invokeTaskZS = l), (this._invokeTaskDlgt = t), (this._invokeTaskCurrZone = this.zone)),
                                    n.onCancelTask || ((this._cancelTaskZS = l), (this._cancelTaskDlgt = t), (this._cancelTaskCurrZone = this.zone)));
                            }
                            return (
                                ...
                                if (r !== w && o instanceof I && o.hasOwnProperty(g) && o.hasOwnProperty(y) && o[g] !== T) z(o), j(e, o[g], o[y]);
                                    ...
                                    if (0 == f.length && r == w) {
                                        ...
                                        try {
                                            throw new Error(
                                                "Uncaught (in promise): " +
                                                    ((i = o) && i.toString === Object.prototype.toString ? ((i.constructor && i.constructor.name) || "") + ": " + JSON.stringify(i) : i ? i.toString() : Object.prototype.toString.call(i)) +
                                                    (o && o.stack ? "\n" + o.stack : "")
                                            );
                                        } catch (v) {
                                            var d = v;
                                ...
                                return (
                                    ...
                                    function () {
                                        ...
                                        if (!c || c(t, v, h, arguments)) {
                                            var y,
                                                m = arguments[2];
                                            if (R) for (var b = 0; b < R.length; b++) if (d === R[b]) return t.apply(this, arguments);
                                            var k = !1;
                                            ...
                                            var z,
                                                ...
                                                L = !1;
                                            if (M) {
                                                if (((L = !0), _)) for (b = 0; b < M.length; b++) if (I(M[b], v)) return;
                                            } else M = h[T] = [];
                    ...
                    if ((!w || S) && !Zone[e.symbol("patchEvents")]) {
                        ...
                        u && de(u && u.prototype, se, o),
                            "undefined" != typeof IDBIndex &&
                                (de(IDBIndex.prototype, le, o), de(IDBRequest.prototype, le, o), de(IDBOpenDBRequest.prototype, le, o), de(IDBDatabase.prototype, le, o), de(IDBTransaction.prototype, le, o), de(IDBCursor.prototype, le, o)),
                ...
                Zone.__load_patch("util", function (n, o, s) {
                    ...
                    n[d] && (n[l] = n[d]),
                        ...
                        (s.getGlobalObjects = function () {
                            return { globalSources: q, zoneSymbolEventNames: W, eventNames: pe, isBrowser: O, isMix: S, isNode: w, TRUE_STR: u, FALSE_STR: f, ZONE_SYMBOL_PREFIX: p, ADD_EVENT_LISTENER_STR: i, REMOVE_EVENT_LISTENER_STR: c };
                        });
                }),
                    (function (e) {
                            ...
                            return function (n, r) {
                                ...
                                "number" == typeof a ? (o = i[a]) : (o = a && a[Ee]) || (o = a),
                                    o && "string" == typeof o.type
                                        ? "notScheduled" !== o.state && ((o.cancelFn && o.data.isPeriodic) || 0 === o.runCount) && ("number" == typeof a ? delete i[a] : a && (a[Ee] = null), o.zone.cancelTask(o))
                                        : t.apply(e, r);
                            };
                        }));
                }
