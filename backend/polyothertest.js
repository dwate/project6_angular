    ...
    [3],
    {
            ...
            if (i("Number", !y(" 0o1") || !y("0b1") || y("+0x1"))) {
                for (
                    var w,
                        ...
                        E = r ? h(y) : "MAX_VALUE,MIN_VALUE,NaN,NEGATIVE_INFINITY,POSITIVE_INFINITY,EPSILON,isFinite,isInteger,isNaN,isSafeInteger,MAX_SAFE_INTEGER,MIN_SAFE_INTEGER,parseFloat,parseInt,isInteger".split(","),
                        S = 0;
                    E.length > S;
                    S++
                )
                            ...
                            function (t, o) {
                                ...
                                for (var b = 0, k = 0, w = []; k < p.length; ) {
                                    ...
                                    if (null === E || (x = v(s(y.lastIndex + (d ? 0 : k)), p.length)) === b) k = u(p, k, g);
                                        ...
                                        for (var S = 1; S <= E.length - 1; S++) if ((w.push(E[S]), w.length === m)) return w;
                                        k = b = x;
                                    }
                                }
                ...
                return [
                    ...
                    function (t, i) {
                        ...
                        for (var k, w = "", x = 0, E = 0; E < m.length; E++) {
                            b = m[E];
                            for (var S = String(b[0]), _ = l(p(c(b.index), v.length), 0), T = [], O = 1; O < b.length; O++) T.push(void 0 === (k = b[O]) ? k : String(k));
                            var A = b.groups;
                            if (d) {
        ...
        SNUk: function (t, e, n) {
            ...
            var r = n("wA6s"),
                ...
                it = function (t, e, n) {
                    t === G && it(Q, e, n), p(t);
                    var r = d(e, !0);
                    return p(n), s(B, r) ? (n.enumerable ? (s(t, Z) && t[Z][r] && (t[Z][r] = !1), (n = y(n, { enumerable: g(0, !1) }))) : (s(t, Z) || Y(t, Z, g(1, {})), (t[Z][r] = !0)), nt(t, r, n)) : Y(t, r, n);
                },
                at = function (t, e) {
                    p(t);
                    var n = v(e),
        ...
        WijE: function (t, e, n) {
            ...
            t.exports = function (t, e, n, f, h, m, b) {
                ...
                if (
                    (M && ((k = i(M.call(new t()))), v !== Object.prototype && k.next && (l || i(k) === v || (a ? a(k, v) : "function" != typeof k[g] && u(k, g, y)), c(k, S, !0, !0), l && (p[S] = y))),
                    "values" == h &&
                        O &&
                        "values" !== O.name &&
                        ((_ = !0),
                    ...
                    if (((w = { values: E("values"), keys: m ? A : E("keys"), entries: E("entries") }), b)) for (x in w) (!d && !_ && x in T) || s(T, x, w[x]);
        ...
        bHwr: function (t, e, n) {
            ...
            var r,
                                ...
                                try {
                                    l
                                        ? (i || (2 === e.rejection && tt(t, e), (e.rejection = 1)),
                                          ...
                                          c === f.promise ? h(Z("Promise-chain cycle")) : (u = B(c)) ? u.call(c, p, h) : p(c))
                                        : h(o);
                                } catch (d) {
                                    v && !s && v.exit(), h(d);
                                }
                ...
                K = function (t, e, n) {
                    var r, o;
                    Y ? (((r = R.createEvent("Event")).promise = e), (r.reason = n), r.initEvent(t, !1, !0), s.dispatchEvent(r)) : (r = { promise: e, reason: n }),
            ...
            U &&
                ...
                ((r = function (t) {
                    C(this, { type: "Promise", done: !1, notified: !1, parent: !1, reactions: [], rejection: !1, state: 0, value: void 0 });
        ...
        "hN/g": function (t, e, n) {
            ...
            (r = function () {
                        ...
                        return (
                            ...
                            (e.prototype.runTask = function (t, e, n) {
                                ...
                                if (t.state !== k || (t.type !== A && t.type !== O)) {
                                    ...
                                    try {
                                        ...
                                        t.state !== k && t.state !== _ && (t.type == A || (t.data && t.data.isPeriodic) ? r && t._transitionTo(x, E) : ((t.runCount = 0), this._updateTaskCount(t, -1), r && t._transitionTo(k, E, k))),
                                            (P = P.parent),
                                            (I = o);
                                    }
                                }
                            ...
                            (e.prototype.scheduleTask = function (t) {
                                ...
                                try {
                                    ...
                                    throw (t._transitionTo(_, w, k), this._zoneDelegate.handleError(this, r), r);
                                }
                                return t._zoneDelegates === n && this._updateTaskCount(t, 1), t.state == w && t._transitionTo(x, w), t;
                            }),
                        ...
                        f = (function () {
                            function t(t, e, n) {
                                ...
                                (r || (e && e._hasTaskZS)) &&
                                    ...
                                    n.onScheduleTask || ((this._scheduleTaskZS = s), (this._scheduleTaskDlgt = e), (this._scheduleTaskCurrZone = this.zone)),
                                    n.onInvokeTask || ((this._invokeTaskZS = s), (this._invokeTaskDlgt = e), (this._invokeTaskCurrZone = this.zone)),
                                    n.onCancelTask || ((this._cancelTaskZS = s), (this._cancelTaskDlgt = e), (this._cancelTaskCurrZone = this.zone)));
                            }
                            return (
                    ...
                    Zone.__load_patch("ZoneAwarePromise", function (t, e, n) {
                        ...
                        (n.onUnhandledError = function (t) {
                            if (n.showUncaughtError()) {
                                var e = t && t.rejection;
                                e
                                    ? console.error("Unhandled Promise rejection:", e instanceof Error ? e.message : e, "; Zone:", t.zone.name, "; Task:", t.task && t.task.source, "; Value:", e, e instanceof Error ? e.stack : void 0)
                                    : console.error(t);
                            }
                        }),
                        ...
                        function j(t, r, o) {
                            ...
                            if (t[g] === x) {
                                ...
                                if (r !== S && o instanceof C && o.hasOwnProperty(g) && o.hasOwnProperty(y) && o[g] !== x) I(o), j(t, o[g], o[y]);
                                    ...
                                    t[g] = r;
                                    var l = t[y];
                                    if (((t[y] = o), t[m] === m && r === E && ((t[g] = t[k]), (t[y] = t[b])), r === S && o instanceof Error)) {
                                    ...
                                    if (0 == l.length && r == S) {
                                        ...
                                        try {
                                            throw new Error(
                                                "Uncaught (in promise): " +
                                                    ((a = o) && a.toString === Object.prototype.toString ? ((a.constructor && a.constructor.name) || "") + ": " + JSON.stringify(a) : a ? a.toString() : Object.prototype.toString.call(a)) +
                                                    (o && o.stack ? "\n" + o.stack : "")
                                            );
                                        } catch (d) {
                                            var v = d;
                        ...
                        var C = (function () {
                            ...
                            return (
                                ...
                                (t.race = function (t) {
                                    ...
                                    try {
                                        for (var s = Object(o.e)(t), f = s.next(); !f.done; f = s.next()) {
                                            var l = f.value;
                                ...
                                (t.allWithCallback = function (t, e) {
                                    var n,
                                        ...
                                        p = this;
                                    try {
                                        for (var v = Object(o.e)(t), d = v.next(); !d.done; d = v.next()) l(d.value);
                                    } catch (g) {
                                        n = { error: g };
                                    } finally {
                                        try {
                ...
                function W(t, e, r) {
                        ...
                        b = function (e) {
                            if ((e = e || t.event)) {
                                ...
                                if (r)
                                    ...
                                    else for (var o = r.slice(), i = 0; i < o.length && (!e || !0 !== e[U]); i++) m(o[i], n, e);
                            }
                        },
                        k = function (e) {
                            if ((e = e || t.event)) {
                    ...
                    function w(e, r) {
                        ...
                        var E,
                            ...
                            j = (x[d(s)] = x[s]);
                        function P(t) {
                            G || "boolean" == typeof T.options || null == T.options || ((t.options = !!T.options.capture), (T.options = t.options));
                        }
                        r && r.prepend && (E = x[d(r.prepend)] = x[r.prepend]);
                        var I = a
                                ? function (t) {
                                      if (!T.isExisting) return P(t), O.call(T.target, T.eventName, T.capture ? k : b, T.options);
                                  }
                                : function (t) {
                                      return P(t), O.call(T.target, T.eventName, t.invoke, T.options);
                                  },
                            D = a
                                ? function (t) {
                                      if (!t.isRemoved) {
                            ...
                            Z = function (e, n, o, i, u, s) {
                                return (
                                    ...
                                    function () {
                                        ...
                                        if (S && "uncaughtException" === v) return e.apply(this, arguments);
                                        var g = !1;
                                        ...
                                        if (!c || c(e, d, h, arguments)) {
                                            var y,
                                                b = arguments[2];
                                            if (N) for (var k = 0; k < N.length; k++) if (v === N[k]) return e.apply(this, arguments);
                                            var w = !1;
                                            void 0 === b ? (y = !1) : !0 === b ? (y = !0) : !1 === b ? (y = !1) : ((y = !!b && !!b.capture), (w = !!b && !!b.once));
                                            var x,
                                                E = Zone.current,
                                                O = V[v];
                                            if (O) x = O[y ? f : l];
                                            ...
                                            var I,
                                                ...
                                                L = !1;
                                            if (D) {
                                                if (((L = !0), m)) for (k = 0; k < D.length; k++) if (C(D[k], d)) return;
                                            } else D = h[x] = [];
                                            var Z = h.constructor.name,
                                                R = H[Z];
                                            R && (I = R[v]), I || (I = Z + n + (_ ? _(v) : v)), (T.options = b), w && (T.options.once = !1), (T.target = h), (T.capture = y), (T.eventName = v), (T.isExisting = L);
                                            var F = a ? q : void 0;
                                            F && (F.taskData = T);
                        ...
                        return (
                            ...
                            (x[u] = function () {
                                var e = this || t,
                                    n = arguments[0];
                                r && r.transferEventName && (n = r.transferEventName(n));
                                for (var o = [], i = B(e, _ ? _(n) : n), a = 0; a < i.length; a++) {
                                    var c = i[a],
                    ...
                    if ((!S || T) && !Zone[t.symbol("patchEvents")]) {
                        ...
                        f && vt(f && f.prototype, ut, o),
                            "undefined" != typeof IDBIndex &&
                                (vt(IDBIndex.prototype, st, o), vt(IDBRequest.prototype, st, o), vt(IDBOpenDBRequest.prototype, st, o), vt(IDBDatabase.prototype, st, o), vt(IDBTransaction.prototype, st, o), vt(IDBCursor.prototype, st, o)),
                ...
                Zone.__load_patch("util", function (n, o, u) {
                    (u.patchOnProperties = j), (u.patchMethod = C), (u.bindArguments = w), (u.patchMacroTask = N);
                    ...
                    n[v] && (n[s] = n[v]),
                        ...
                        (u.getGlobalObjects = function () {
                            return { globalSources: H, zoneSymbolEventNames: V, eventNames: pt, isBrowser: _, isMix: T, isNode: S, TRUE_STR: f, FALSE_STR: l, ZONE_SYMBOL_PREFIX: p, ADD_EVENT_LISTENER_STR: a, REMOVE_EVENT_LISTENER_STR: c };
                        });
                }),
                    (function (t) {
                        ...
                        return (
                            (n.args[0] = function () {
                                try {
                                    ...
                                    (e.data && e.data.isPeriodic) || ("number" == typeof n.handleId ? delete a[n.handleId] : n.handleId && (n.handleId[Et] = null));
                                }
                            }),
                            ...
                            return function (n, r) {
                                ...
                                "number" == typeof i ? (o = a[i]) : (o = i && i[Et]) || (o = i),
                                    o && "string" == typeof o.type
                                        ? "notScheduled" !== o.state && ((o.cancelFn && o.data.isPeriodic) || 0 === o.runCount) && ("number" == typeof i ? delete a[i] : i && (i[Et] = null), o.zone.cancelTask(o))
                                        : e.apply(t, r);
                            };
                        }));
                }
                    ...
                    Zone.__load_patch("XHR", function (t, e) {
                        !(function (t) {
                            ...
                            function _(t) {
                                ...
                                return p.call(a, m, l), a[n] || (a[n] = t), E.apply(a, r.args), (a[i] = !0), t;
                            }
                            function T() {}
                            function O(t) {
                                var e = t.data;
            ...
            var r = n("SxYf"),
                ...
                s = function (t) {
                    ...
                    return function (h, v, d, g) {
                        for (var y, m, b = i(h), k = o(b), w = r(v, d, 3), x = a(k.length), E = 0, S = g || c, _ = e ? S(h, x) : n ? S(h, 0) : void 0; x > E; E++)
                ...
                return (
                    ...
                    (O.prototype = {
                        ...
                        delegateYield: function (t, n, r) {
                            return (this.delegate = { iterator: A(t), resultName: n, nextLoc: r }), "next" === this.method && (this.arg = e), v;
                        },
                    }),
                    t
                );
            ...
            r(
                { target: "Array", proto: !0, forced: !f("splice") },
                {
                    splice: function (t, e) {
                        ...
                        } else if (n > r) for (h = y - r; h > m; h--) (d = h + n - 1), (v = h + r - 1) in g ? (g[d] = g[v]) : delete g[d];
